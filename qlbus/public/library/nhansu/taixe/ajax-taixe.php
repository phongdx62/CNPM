	...
	<div id="add-data" style="margin-left: 300px; width: 500px;">
		...
		<form method="post">		
			<div class="row">
				<div class="col-md-3 mb-3" style="margin-top: 8px;color: #993333;"><b>Tên tài xế</b></div>
			...
			<div class="row">
				<div class="col-md-3 mb-3" style="margin-top: 8px;color: #993333;"><b>Loại bằng</b></div>
				<div class="col-md-9 mb-3">
					<label for="inputPassword" class="sr-only"></label>
			...
			<br>
			<center><button type="button" id="save-tx" class="btn btn-primary"><span class="glyphicon glyphicon-save"></span>Thêm tài xế</button><button type="button" id="update-tx" class="btn btn-warning"><span class="glyphicon glyphicon-edit"></span>Sửa thông tin</button></center>
			<br>
			<div>
				<?php  
					if(isset($msg))
...
<script src="public/core/js/nhansu/script-tx.js"></script>